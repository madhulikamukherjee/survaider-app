...
class AspectQ(db.Document):
	...
	time_review = DateTimeField(default='1980-01-01')
...
class ZomatoQ(AspectQ):
	provider = StringField(default="zomato")

class TripAdvisorQ(AspectQ):
	provider = StringField(default="tripadvisor")

class HolidayIQQ(AspectQ):
	provider = StringField(default="HolidayIQ")

class BookingQ(AspectQ):
	provider = StringField(default="booking")
